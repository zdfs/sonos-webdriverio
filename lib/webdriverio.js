...
module.exports = {
	...
	setupGrunt: function(gruntConfig) {
		...
		_(this.environments()).forEach(function(environment, key) {
			...
			if (gruntConfig.webdriver.options.browserstack.user !== '' && gruntConfig.webdriver.options.browserstack.key !== '') {
			...
			if (gruntConfig.webdriver.options.saucelabs.user !== '' && gruntConfig.webdriver.options.saucelabs.key !== '') {
